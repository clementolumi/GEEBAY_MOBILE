  ...
  bool requiredFieldVerification() {
    if (productNameEditTextController.text.trim().toString().isEmpty) {
      ToastComponent.showDialog(
        LangText(context).local.product_name_required,
      );
      return false;
    } else if (unitEditTextController.text.trim().toString().isEmpty) {
      ToastComponent.showDialog(
        LangText(context).local.product_unit_required,
      );
      return false;
    } else if (locationTextController.text.trim().toString().isEmpty) {
      ToastComponent.showDialog(
        LangText(context).local.location_required,
      );
      return false;
    } else if (tags!.isEmpty) {
      ToastComponent.showDialog(
        LangText(context).local.product_tag_required,
      );
      return false;
