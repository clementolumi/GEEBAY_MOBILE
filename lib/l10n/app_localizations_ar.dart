...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get auction_biding_price_date_range_ucf => 'سعر عرض أسعار المنتج + النطاق الزمني';
  ...
  @override
  String get are_you_sure_to_mark_this_as_delivered => 'هل أنت متأكد من وضع علامة على هذا على أنه تم التسليم؟';

  @override
  String get are_you_sure_to_mark_this_as_picked_up => 'هل أنت متأكد من تحديد هذا على أنه محدد؟';

  @override
  String get are_you_sure_to_request_cancellation => 'هل أنت متأكد من طلب الإلغاء؟';
  ...
  @override
  String get are_you_sure_to_remove_this_address => 'هل أنت متأكد من إزالة هذا العنوان؟';

  @override
  String get addresses_of_user => 'عناوين المستخدمين';

  @override
  String get double_tap_on_an_address_to_make_it_default => 'انقر نقرًا مزدوجًا على عنوان لجعله افتراضيًا';
  ...
  @override
  String get loading_more_brands_ucf => 'جارٍ تحميل المزيد من العلامات التجارية ...';
  ...
  @override
  String get go_to_your_application_settings_and_give_photo_permission => 'انتقل إلى إعدادات التطبيق الخاص بك ومنح الإذن للصور';
  ...
  @override
  String get are_you_sure_to_remove_this_item => 'هل أنت متأكد من إزالة هذا العنصر؟';
  ...
  @override
  String get please_log_in_to_see_the_cart_items => 'الرجاء تسجيل الدخول لعرض عناصر عربة التسوق';
  ...
  @override
  String get please_turn_on_your_internet_connection => 'يرجى تشغيل اتصال الإنترنت الخاص بك';

  @override
  String get please_log_in_to_see_the_profile => 'الرجاء تسجيل الدخول لعرض الملف الشخصي';
  ...
  @override
  String get delete_account_warning_description => 'بمجرد حذف حسابك من نظامنا ، ستفقد رصيدك والمعلومات الأخرى من نظامنا.';
  ...
  @override
  String get you_can_use_filters_while_searching_for_products => 'يمكنك استخدام المرشحات أثناء البحث عن المنتجات.';
  ...
  @override
  String get you_can_use_sorting_while_searching_for_products => 'يمكنك استخدام الفرز أثناء البحث عن المنتجات.';

  @override
  String get filter_screen_min_max_warning => 'لا يمكن أن يكون الحد الأدنى للسعر أكبر من الحد الأقصى للسعر';
  ...
  @override
  String get title_or_message_empty_warning => 'لا يمكن أن يكون العنوان أو الرسالة فارغين';
  ...
  @override
  String get top_selling_products_from_seller => 'المنتجات الأكثر مبيعًا من هذا البائع';
  ...
  @override
  String get no_top_selling_products_from_this_seller => 'لا توجد منتجات للبيع من هذا البائع';
  ...
  @override
  String get to_add_or_edit_addresses_go_to_address_page => 'لإضافة أو تحرير العناوين ، انتقل إلى صفحة العنوان';
  ...
  @override
  String get please_log_in_to_see_the_wishlist_items => 'الرجاء تسجيل الدخول لعرض عناصر قائمة الرغبات';
  ...
  @override
  String get password_must_contain_at_least_6_characters => 'يجب أن تحتوي كلمة المرور على 6 أحرف على الأقل';
  ...
  @override
  String get enter_the_verification_code_that_sent_to_your_email_recently => 'أدخل رمز التحقق الذي تم إرساله إلى بريدك الإلكتروني مؤخرًا.';

  @override
  String get enter_the_verification_code_that_sent_to_your_phone_recently => 'أدخل رمز التحقق الذي تم إرساله إلى هاتفك مؤخرًا.';
  ...
  @override
  String get you_have_successfully_changed_your_password => 'لقد غيرت كلمة سرك بنجاح';
  ...
  @override
  String get if_you_are_finding_any_problem_while_logging_in => 'إذا وجدت أي مشكلة أثناء تسجيل الدخول ، يرجى الاتصال بالمسؤول';
  ...
  @override
  String get amount_name_and_transaction_id_are_necessary => 'المبلغ والاسم ومعرف المعاملة ضرورية';
  ...
  @override
  String get correctly_fill_up_the_necessary_information => 'أدخل المعلومات اللازمة بشكل صحيح. في وقت لاحق لا يمكنك تحرير أو إعادة إرسال النموذج';
  ...
  @override
  String get no_reviews_yet_be_the_first => 'لا تعليقات حتى الآن. كن أول من يراجع هذا المنتج';

  @override
  String get you_need_to_login_to_give_a_review => 'تحتاج إلى تسجيل الدخول لتقديم الاستعراض';

  @override
  String get review_can_not_empty_warning => 'لا يمكن أن تكون المراجعة فارغة';

  @override
  String get at_least_one_star_must_be_given => 'يجب إعطاء نجمة واحدة على الأقل';
  ...
  @override
  String get no_featured_product_is_available_from_this_seller => 'لا يوجد منتج مميز متاح من هذا البائع';

  @override
  String get no_new_arrivals => 'لا يوجد قادمون جدد';

  @override
  String get view_all_products_prom_this_seller_all_capital => 'عرض جميع المنتجات من هذا البائع';
  ...
  @override
  String get please_select_minimum_1_product_ucf => 'الرجاء تحديد منتج واحد على الأقل';
  ...
  @override
  String get type_and_hit_enter_to_add_a_tag_ucf => 'اكتب واضغط على Enter لإضافة علامة';
  ...
  @override
  String get thumbnail_image_300_des => 'هذه الصور مرئية على علبة جميع المنتجات. استخدم صورة بحجم 300 × 300. احتفظ ببعض المساحة الفارغة حول الكائن الرئيسي لصورتك حيث كان علينا قص بعض الحواف في أجهزة مختلفة لجعلها مستجيبة.';
  ...
  @override
  String get video_link_des => 'استخدم الارتباط المناسب بدون معلمة إضافية. لا تستخدم رابط المشاركة المختصر / كود iframe المضمن.';
  ...
  @override
  String get leave_it_blank_if_you_do_not_use_external_site_link => 'اتركه فارغًا إذا كنت لا تستخدم ارتباط موقع خارجي';
  ...
  @override
  String get shipping_configuration_is_maintained_by_admin => 'يتم الاحتفاظ بتكوين الشحن من قبل المسؤول.';
  ...
  @override
  String get these_images_are_visible_in_product_details_page_gallery_600 => 'هذه الصور مرئية في معرض صفحة تفاصيل المنتج. استخدم 600 × 600 صورة.';
  ...
  @override
  String get banner_1500_x_450_des => 'كان علينا تحديد الارتفاع للحفاظ على الاتساق. في بعض الأجهزة ، قد يتم اقتصاص جانبي الشعار لتقليل الارتفاع.';
  ...
  @override
  String get in_case_of_any_difficulties_contact_with_admin => 'في حالة وجود أي صعوبات ، اتصل بالمسؤول.';
  ...
  @override
  String get we_will_send_you_a_OTP_code_if_the_mail_id_is_correct_ucf => 'سنرسل لك رمز OTP إذا كان معرف البريد صحيحًا.';

  @override
  String get we_will_send_you_a_OTP_code_if_the_phone_no_is_correct_ucf => 'سنرسل لك رمز OTP إذا كان رقم الهاتف صحيحًا.';
  ...
  @override
  String get value_must_be_greater => 'يجب أن تكون القيمة أكبر من الحد الأدنى لعرض التسعير';

  @override
  String get value_must_be_greater_or_equal => 'يجب أن تكون القيمة أكبر من أو تساوي الحد الأدنى لعرض التسعير';
