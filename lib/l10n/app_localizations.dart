...
abstract class AppLocalizations {
  ...
  /// No description provided for @pay_with_global_pay.
  ///
  /// In en, this message translates to:
  /// **'Pay with Global Pay'**
  String get pay_with_global_pay;

  /// No description provided for @fetching_global_pay_url.
  ///
  /// In en, this message translates to:
  /// **'Launching Global Pay ...'**
  String get fetching_global_pay_url;
